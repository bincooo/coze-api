...
func TestChat(t *testing.T) {
	options := NewDefaultOptions("7353047124357365778", "1716940640540", 2, false, "http://127.0.0.1:7890")
	chat := New(cookie, msToken, options)
	//messages := []Message{
	//	{
	//		Role:    "user",
	...
	ch, err := chat.Reply(timeout, Text, "<|user|>\n"+
		"describe this\n"+
		"\n"+
		"*image*: https://complete-mmx-easy-images.hf.space/images/26b423e994b9ca7a27ebd08d436a501c.jpg\n"+
		"----<|end|>\n"+
		"<|assistant|>")
	if err != nil {
		t.Fatal(err)
